...
#define hdmitx_ENABLE_AVI_INFOFRM_PKT(it6161)  { it6161_hdmi_tx_write(it6161, REG_TX_AVI_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_AUD_INFOFRM_PKT(it6161)  { it6161_hdmi_tx_write(it6161, REG_TX_AUD_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
...
#define hdmitx_DISABLE_VSDB_PKT(it6161)        { it6161_hdmi_tx_write(it6161, REG_TX_3D_INFO_CTRL,0); }
...
#define hdmitx_DISABLE_AVI_INFOFRM_PKT(it6161) { it6161_hdmi_tx_write(it6161, REG_TX_AVI_INFOFRM_CTRL,0); }
